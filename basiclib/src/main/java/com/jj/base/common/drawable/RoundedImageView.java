...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (index >= 0) {
            ...
            // holder scaletype to FIT_CENTER
        ...
        if (mMutateBackground) {
            ...
            // so it's false by holder, what doesn't allow to create the RoundedDrawable. At this point, after load
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        if (null != callback) {
            callback.onImageSet(this, getDrawable());
        }
    }
    ...
    public void setOnImageSetCallback(OnImageSetCallback callback) {
        this.callback = callback;
    }


    public interface OnImageSetCallback {
        void onImageSet(RoundedImageView imageView, Drawable drawable);
    }
}
