...
public class SlideTabLayout extends HorizontalScrollView {
    ...
    public SlideTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        slidingTabIndicator.setUnSelectedIndicatorColor(
                a.getColor(com.jj.basiclib.R.styleable.TabLayout_tabUnselectedIndicatorColor, 0));
        ...
        tabTextLayoutRes =
                a.getResourceId(com.jj.basiclib.R.styleable.TabLayout_tabTextLayout, com.google.android.material.R.layout.design_layout_tab_text);
        tabSelectedBold =
                a.getBoolean(com.jj.basiclib.R.styleable.TabLayout_tabSelectedBold, false);
        ...
        tabRippleColorStateList = AppCompatResources.getColorStateList(context, com.jj.basiclib.R.color.basic_transparent);
//                MaterialResources.getColorStateList(context, a, R.styleable.TabLayout_tabRippleColor);
        ...
        tabBackgroundMargin = a.getDimensionPixelSize(com.jj.basiclib.R.styleable.TabLayout_tabBackgroundMargin, 0);
