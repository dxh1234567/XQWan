 ...
 * 注意只能用于纯文本排序
 */
public class AlignTextView2 extends AppCompatTextView {
    ...
    public AlignTextView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AlignTextView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int alignStyle = ta.getInt(R.styleable.AlignTextView2_align, 0);
        switch (alignStyle) {
            case 1:
