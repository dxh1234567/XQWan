...
public class SlideTabLayout extends HorizontalScrollView {
    ...
    private static final String LOG_TAG = "SlideTabLayout";
     ...
     * SlideTabLayout's content width. Fixed tabs have equal width, based on the widest tab label. Once the
    ...
    /**
     * Gravity used to fill the {@link SlideTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link SlideTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Gravity used to lay out the tabs aligned to the start of the {@link SlideTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
     ...
     * SlideTabLayout}. This will only take effect if the indicator height is set via the custom indicator
     ...
     * width of the {@link SlideTabLayout}. This will disregard {@code tabIndicatorHeight} and the
    ...
    public SlideTabLayout(@NonNull Context context) {
        this(context, null);
    }

    public SlideTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.tabStyle);
    }

    public SlideTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        slidingTabIndicator.setUnSelectedIndicatorColor(
                a.getColor(cn.jj.basiclib.R.styleable.TabLayout_tabUnselectedIndicatorColor, 0));
        ...
        tabTextLayoutRes =
                a.getResourceId(cn.jj.basiclib.R.styleable.TabLayout_tabTextLayout, com.google.android.material.R.layout.design_layout_tab_text);
        tabSelectedBold =
                a.getBoolean(cn.jj.basiclib.R.styleable.TabLayout_tabSelectedBold, false);
        ...
        tabRippleColorStateList = AppCompatResources.getColorStateList(context, cn.jj.basiclib.R.color.basic_transparent);
//                MaterialResources.getColorStateList(context, a, R.styleable.TabLayout_tabRippleColor);
        ...
        tabBackgroundMargin = a.getDimensionPixelSize(cn.jj.basiclib.R.styleable.TabLayout_tabBackgroundMargin, 0);
        ...
        scrollableTabMinWidth = res.getDimensionPixelSize(cn.jj.basiclib.R.dimen.custom_tab_scrollable_min_width);
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        if (tab.parent != this) {
            throw new IllegalArgumentException("Tab belongs to a different SlideTabLayout.");
        }
    ...
    /**
     * Add a {@link SlideTabLayout.OnTabSelectedListener} that will be invoked when tab selection changes.
     *
    ...
    /**
     * Add a {@link SlideTabLayout.BaseOnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via {@link
    ...
    /**
     * Remove the given {@link SlideTabLayout.OnTabSelectedListener} that was previously added via {@link
    ...
    /**
     * Remove the given {@link SlideTabLayout.BaseOnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link SlideTabLayout.OnTabSelectedListener}s.
     */
    ...
    public void removeTab(@NonNull Tab tab) {
        if (tab.parent != this) {
            throw new IllegalArgumentException("Tab does not belong to this SlideTabLayout.");
        }
    ...
    /**
     * Returns the current mode used by this {@link SlideTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * Set the indicator gravity used to align the tab selection indicator in the {@link SlideTabLayout}.
     ...
     * indicator height and stretch across the entire height and width of the {@link SlideTabLayout}. This
    ...
    /**
     * Set whether this {@link SlideTabLayout} will have an unbounded ripple effect or if ripple will be
    ...
    /**
     * Returns whether this {@link SlideTabLayout} has an unbounded ripple effect, or if ripple is bound to
     * the tab item size.
     *
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabUnboundedRipple
    ...
    /**
     * Returns the ripple color for this SlideTabLayout.
     *
    ...
    /**
     * Sets the ripple color for this SlideTabLayout.
     *
    ...
    /**
     * Sets the ripple color resource for this SlideTabLayout.
     *
     * <p>When running on devices with KitKat or below, we draw this color as a filled overlay rather
     * than a ripple.
     *
    ...
    /**
     * Returns the selection indicator drawable for this SlideTabLayout.
     *
    ...
    /**
     * Sets the selection indicator for this SlideTabLayout. By default, this is a line along the bottom of
     * the tab. If {@code tabIndicatorColor} is specified via the SlideTabLayout's style or via {@link
    ...
    /**
     * Sets the drawable resource to use as the selection indicator for this SlideTabLayout. By default,
     * this is a line along the bottom of the tab. If {@code tabIndicatorColor} is specified via the
     * SlideTabLayout's style or via {@link #setSelectedTabIndicatorColor(int)} the selection indicator
    ...
    /**
     * The one-stop shop for setting up this {@link SlideTabLayout} with a {@link ViewPager}.
     *
     ...
     * The one-stop shop for setting up this {@link SlideTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will link the given ViewPager and this SlideTabLayout together so that changes in one
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link a SlideTabLayout with a ViewPager
     * together. When that method is used, the SlideTabLayout will be automatically updated when the
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TabItem) {
            ...
            throw new IllegalArgumentException("Only TabItem instances can be added to SlideTabLayout");
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // height
        final int idealHeight = Math.round(ScreenUtil.dp2px(getDefaultHeight()));
        ...
        if (MeasureSpec.getMode(widthMeasureSpec) != MeasureSpec.UNSPECIFIED) {
            ...
            tabMaxWidth =
                    requestedTabMaxWidth > 0
                            ? requestedTabMaxWidth
                            : (int) (specWidth - ScreenUtil.dp2px(TAB_MIN_WIDTH_MARGIN));
        }
    ...
    /**
     * Called when a selected tab is added. Unselects all other tabs in the SlideTabLayout.
     *
    ...
    public static class Tab {
        ...
        public Tab setIcon(@DrawableRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a SlideTabLayout");
            }
    ...
    /**
     * A {@link LinearLayout} containing {@link Tab} instances for use with {@link SlideTabLayout}.
     */
    public final class TabView extends LinearLayout {
         ...
         * tab background underneath the SlideTabLayout selection indicator, and then draw the SlideTabLayout
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                SlideTabLayout.this.invalidate(); // Invalidate SlideTabLayout, which draws mBaseBackgroundDrawable
            }
        }
        ...
        private void updateTextAndIcon(
            ...
            if (iconView != null) {
                ...
                if (hasText && iconView.getVisibility() == VISIBLE) {
                    ...
                    iconMargin = (int) ScreenUtil.dp2px(DEFAULT_GAP_TEXT_ICON);
                }
                if (inlineLabel) {
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private int unSelectedIndicatorColor = 0xFFE5EAF0;
        @NonNull
        ...
        protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
            ...
            if ((tabGravity == GRAVITY_CENTER) || mode == MODE_AUTO) {
                ...
                final int gutter = (int) ScreenUtil.dp2px(FIXED_WRAP_GUTTER_MIN);
                boolean remeasure = false;
...
//            final View selectedTitle = getTabAt(selectedPosition).view.textView;
            int left;
            int right;
        ...
        private void calculateTabViewContentBounds(
            ...
            int minIndicatorWidth = (int) ScreenUtil.dp2px(MIN_INDICATOR_WIDTH);
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            } else if (tabSelectedIndicator != null) {
                Tab tab = getTabAt(0);
                if (tab != null && tab.view.textView != null) {
                    indicatorHeight = tab.view.textView.getHeight();
                }
            ...
            for (int i = 0; i < getTabCount(); i++) {
                View view = tabs.get(i).view.textView;
                ViewUtil.getDescendantRectRelativeToAncestor(view, this, tempRect);
                Drawable unselectedIndicator =
                        DrawableCompat.wrap(
                                tabSelectedIndicator != null ? tabSelectedIndicator : defaultSelectionIndicator)
                                .mutate();
                unselectedIndicator.setBounds(tempRect);
                if (VERSION.SDK_INT == VERSION_CODES.LOLLIPOP) {
                    // Drawable doesn't implement setTint in API 21
                    unselectedIndicator.setColorFilter(unSelectedIndicatorColor, PorterDuff.Mode.SRC_IN);
                } else {
                    DrawableCompat.setTint(unselectedIndicator, unSelectedIndicatorColor);
                }
                unselectedIndicator.draw(canvas);
            }
     ...
     * provided {@link SlideTabLayout} so that the tab position is kept in sync.
     *
     * <p>This class stores the provided SlideTabLayout weakly, meaning that you can use {@link
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull
        private final WeakReference<SlideTabLayout> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        public TabLayoutOnPageChangeListener(SlideTabLayout tabLayout) {
        ...
        public void onPageScrolled(
            ...
            final SlideTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link SlideTabLayout.OnTabSelectedListener} class which contains the necessary calls back to the
     * provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements SlideTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(@NonNull SlideTabLayout.Tab tab) {
            viewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(SlideTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(SlideTabLayout.Tab tab) {
            // No-op
        }
    }
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (SlideTabLayout.this.viewPager == viewPager) {
