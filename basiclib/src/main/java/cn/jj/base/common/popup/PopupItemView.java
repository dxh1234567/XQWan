package cn.jj.base.common.popup;
...
import cn.jj.base.common.anim.LogAccelerateInterpolator;
import cn.jj.base.utils.SystemUtil;

import cn.jj.basiclib.R;

import static android.graphics.Canvas.ALL_SAVE_FLAG;
import static cn.jj.base.utils.Constant.ATLEAST_LOLLIPOP;
...
public abstract class PopupItemView extends FrameLayout
    ...
    public PopupItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (ATLEAST_LOLLIPOP) {
            ...
            canvas.drawArc(new RectF(0, 0, radius * 2, radius * 2), 180, 90, true, mBackgroundClipPaint);
        }
        mBackgroundClipPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        mIsRtl = SystemUtil.isRTL();
    }
...
//        mIconView = findViewById(R.id.popup_item_icon);
    ...
    protected void dispatchDraw(Canvas canvas) {
        int saveCount = canvas.saveLayer(0, 0, getWidth(), getHeight(), null, ALL_SAVE_FLAG);
    ...
    public Animator createOpenAnimation(boolean isContainerAboveIcon, boolean pivotLeft) {
        ...
        if (ATLEAST_LOLLIPOP) {
            openAnimator = new ZoomRevealOutlineProvider(center.x, center.y,
                    mPillRect, this, mIconView, isContainerAboveIcon, pivotLeft, arrowCenter)
                    .createRevealAnimator(this, false);
        } else {
            openAnimator = ValueAnimator.ofFloat(1f, 0f);
        }
    ...
    public Animator createCloseAnimation(boolean isContainerAboveIcon, boolean pivotLeft,
        ...
        if (ATLEAST_LOLLIPOP) {
            closeAnimator = new ZoomRevealOutlineProvider(center.x, center.y,
                    mPillRect, this, mIconView, isContainerAboveIcon, pivotLeft, arrowCenter)
