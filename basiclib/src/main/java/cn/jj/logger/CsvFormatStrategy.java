...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    public File getLogFile() {
        if (logStrategy instanceof DiskLogStrategy) {
            return ((DiskLogStrategy) logStrategy).getLogFile();
        }
        return null;
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder filePath(@Nullable String path) {
            this.filePath = path;
            return this;
        }
        ...
        public CsvFormatStrategy build() {
            ...
            if (logStrategy == null) {
                ...
                ht.start();
                Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), filePath, maxBytes, context);
