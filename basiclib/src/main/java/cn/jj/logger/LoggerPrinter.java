...
import static cn.jj.logger.Logger.ASSERT;
import static cn.jj.logger.Logger.DEBUG;
import static cn.jj.logger.Logger.ERROR;
import static cn.jj.logger.Logger.INFO;
import static cn.jj.logger.Logger.VERBOSE;
import static cn.jj.logger.Logger.WARN;
import static cn.jj.logger.Utils.checkNotNull;
...
class LoggerPrinter implements Printer {
    ...
    public File getLogFile() {
        for (LogAdapter adapter : logAdapters) {
            if (adapter instanceof DiskLogAdapter) {
                return ((DiskLogAdapter) adapter).getLogFile();
            }
        }
        return null;
    }
